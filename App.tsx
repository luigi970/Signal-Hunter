            ...
            <div className="flex items-center gap-4">
              {profile && (
                <div className="hidden md:flex items-center gap-3">
                  <div className="flex items-center gap-1.5 text-xs font-bold text-zinc-400 uppercase tracking-tight px-3 py-1.5 bg-zinc-900/50 border border-zinc-800 rounded-full">
              ...
              <SubscribeButton 
                ...
                priceId="price_1SmeRyBpXPH1XQeAjY7mfjli"
              />
